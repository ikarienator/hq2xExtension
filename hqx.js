...
(function (window) {
    ...
    var _Interp2 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 2 + (c2 >>> 24) + (c3 >>> 24)) / 4 << 24;
    };
    ...
    var _Interp4 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 2 + (c2 >>> 24) * 7 + (c3 >>> 24) * 7) / 16 << 24;
    };
    ...
    var _Interp6 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 5 + (c2 >>> 24) * 2 + (c3 >>> 24)) / 8 << 24;
    };
    ...
    var _Interp7 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 6 + (c2 >>> 24) + (c2 >>> 24)) / 8 << 24;
    };
    ...
    var _Interp9 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 2 + (c2 >>> 24) * 3 + (c2 >>> 24) * 3) / 8 << 24;
    };
    ...
    var _Interp10 = function (pc, c1, c2, c3) {
        ...
        _dest[pc] |= ((c1 >>> 24) * 14 + (c2 >>> 24) + (c2 >>> 24)) / 16 << 24;
    };


    window.___$$$___hqx = function (img, scale) {
        ...
        for (var i = 0; i < count; i++) {
            var a = origPixels[(index = i * 4) + 3],
                b = origPixels[index + 2],
                g = origPixels[index + 1],
                r = origPixels[index]
            src[i] = (a << 24) |
                (b << 16) |
                (g << 8) |
        ...
        for (var j = 0; j < destLength; j++) {
            a = ((c = dest[j])) >> 24;
            scaledPixelsData[(index = j << 2) + 3] = a < 0 ? a + 256 : a; // signed/unsigned :/
